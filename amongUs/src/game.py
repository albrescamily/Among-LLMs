...
class Game:
    ...
    def update(self):
        ...
        # Imposter kills a bot by walking into it and pressing RETURN.
        kills.apply_bot_kills(self, pg.key.get_pressed())
    ...
    def draw(self):
        ...
        # Whichever task windows are open; see core/task_render.py.
        task_render.draw_task_windows(self)
