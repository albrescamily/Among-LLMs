...
#### Singleplayer
* To start the game `python amongUs/src/main.py`
* Choose 'Freeplay' from the menu to start playing

#### Local Multiplayer
* To start the game server for multiplayer support `python amongUs/src/server.py`
* To start the game client `python amongUs/src/main.py`
...
* To start the voice chat server `python amongUs/src/server_voice.py`
* To start the voice chat client `python amongUs/src/voice.py`
